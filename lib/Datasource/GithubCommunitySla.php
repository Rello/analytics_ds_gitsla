...
class GithubCommunitySla implements IDatasource {
	...
	public function readData($option): array {
		...
		$repositories = isset($option['repo']) && $option['repo'] !== '' ? array_map('trim', explode(',', $option['repo'])) : $this->repositories;
		$excludedAuthors = isset($option['exclude']) && $option['exclude'] !== '' ? array_map('trim', explode(',', $option['exclude'])) : $this->excludedAuthors;
